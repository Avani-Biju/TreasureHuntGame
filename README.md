...
<img width="1239" height="796" alt="Screenshot 2025-10-15 223348" src="https://github.com/user-attachments/assets/3e0de61f-97cc-4dd8-ab1e-455991034737" />
...
src/├── TreasureHuntGame.java   
### Main controller: Grid, clicks, scoring, state
├── RegularHintGenerator.java 
### Hint logic (Manhattan distance, trap detection)
├── ScoreBoard.java          
### Reads/Writes scores (File I/O)
├── ScoreEntry.java          
###Player score model + sorting logic
├── GameTimer.java           
### Reusable countdown timer utility
├── Cell.java                
### Grid cell component (Button + metadata)
├── HomePage.java             
### Main Menu UI
└── Main.java                
### Application entry point (launches UI)
